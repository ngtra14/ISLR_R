...
## ----large-scatter-plot,       "A scatter plot with too many points."----
d %>% ggplot(aes(x = x, y = y)) +
  geom_point()

## ----large-scatter-plot-alpha,    "A scatter plot with alpha values."----
d %>% ggplot(aes(x = x, y = y)) +
  geom_point(alpha = 0.2)

## ----density-2d-plot,         "A 2D density plot."-----------------------
d %>% ggplot(aes(x = x, y = y)) +
  geom_density_2d()
...
## ----combined-hex-density-plot,"A plot combining hex and 2D density."----
d %>% ggplot(aes(x = x, y = y)) +
  geom_hex() +
