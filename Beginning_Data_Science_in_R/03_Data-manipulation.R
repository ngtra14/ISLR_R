...
## ---- cache=TRUE---------------------------------------------------------
writeLines(lines, con = "raw-breast-cancer.csv")

## ------------------------------------------------------------------------
raw_breast_cancer <- read.csv("raw-breast-cancer.csv")
...
## ---- echo=FALSE---------------------------------------------------------
data_url <- "raw-breast-cancer.csv"
...
## ------------------------------------------------------------------------
formatted_breast_cancer %>%
    save(file = "formatted-breast-cancer.rda")

## ------------------------------------------------------------------------
load("formatted-breast-cancer.rda")
...
## ------------------------------------------------------------------------
raw_breast_cancer <- read_csv("raw-breast-cancer.csv")
raw_breast_cancer %>% head(3)
...
## ----iris_species_vs_petal_length,"Plot species versus petal length."----
...
## ---iris_attributes_vs_mesurements "Plot measurements versus values."----
iris %>% 
  gather(key = Attribute, value = Measurement, 
         Sepal.Length, Sepal.Width) %>%
  select(Species, Attribute, Measurement) %>%
